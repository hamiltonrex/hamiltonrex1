...
// Preparar a consulta para buscar os colaboradores por nome, RG, CPF, PIX, telefone ou email
$sql = "SELECT * FROM colaboradores WHERE nome LIKE ? OR rg LIKE ? OR cpf LIKE ? OR pix LIKE ? OR telefone LIKE ? OR email LIKE ?";
...
// Bind os parâmetros de busca (nome, rg, cpf, pix, telefone, email)
...
<head>
    ...
    <link rel="stylesheet" href="css/buscar_colaborador.css"> <!-- Seu CSS -->
        ...
        <main>
            <div class="content-container">
                ...
                <form method="GET" action="buscar_colaborador.php">
                    <input type="text" name="query" placeholder="Buscar por nome, RG, CPF, PIX, telefone ou email" value="<?php echo htmlspecialchars($query); ?>">
